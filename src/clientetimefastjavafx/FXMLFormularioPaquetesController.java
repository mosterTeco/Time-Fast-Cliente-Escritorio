...
public class FXMLFormularioPaquetesController implements Initializable {
    ...
    @FXML
    private void OnClickSeleccionarEnvio(ActionEvent event) {
        try {
            Stage escenarioSelec = new Stage();
            Parent root = FXMLLoader.load(getClass().getResource("FXMLEnviosDisponibles.fxml"));
            Scene scene = new Scene(root);
            escenarioSelec.setScene(scene);
            escenarioSelec.setTitle("Seleccionar envio");
